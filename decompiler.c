...
int Disassemble8080Op(unsigned char *codebuffer, int pc){
	...
	switch (*code)
	{
		...
		//load register pair to immediate	
		...
		//rotate A bits left through carry
		...
		//roate A bits right through carry
		...
		//M Address refers to HL
		//MOV moves register to register
		...
		//Add to register A with carry (ex A = A + B + CY)
		...
		//if NZ, return (NZ = nonzero?)
		case 0xc0: printf("RNZ"); break;
		//Puts top of stack in Byte pair (BE)
		case 0xc1: printf("POP    B"); break;
		//if NZ, jump
		case 0xc2: printf("JNZ    $%02x%02x",code[2],code[1]); opbytes = 3; break;
		//Unconditional Jump to location Addr.
		case 0xc3: printf("JMP    $%02x%02x",code[2],code[1]); opbytes = 3; break;
		//if NZ, call
		case 0xc4: printf("CNZ    $%02x%02x",code[2],code[1]); opbytes = 3; break;
		//Put byte pair on the top of the stack
		case 0xc5: printf("PUSH   B"); break;
		//Add address contents to A (8 bit)
		...
		//unconditional call to address
		case 0xcd: printf("CALL   $%02x%02x",code[2],code[1]); opbytes = 3; break;
		//Add with carry immediate (A = A + byte)
		...
		//Data from register A placed in port
		...
		//Subtract from A with borrow immediate
		...
		//puts contents of HL into PC (Program Counter)
		...
		//Puts contents of HL into SP (Stack pointer)
